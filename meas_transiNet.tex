...
The \texttt{meas\_transiNet} defines ``model packages'' that consist of a python architecture class, a PyTorch \citep{paszke2019pytorch} weights file, and associated metadata.
