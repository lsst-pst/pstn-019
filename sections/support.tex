...
For the purposes of this count, the Science Pipelines are defined as the \texttt{lsst_distrib} metapackage and do not include code from third-party packages nor from the Solar System Pipeline.
