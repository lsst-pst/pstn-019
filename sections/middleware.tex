...
The run collection can be thought of as a or logical grouping of datasets created by the same batch operation, but does not have to correspond to any physical structure in a file system.
