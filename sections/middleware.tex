...
This separation of data model from serialization gives us the flexibility to adopt different file formats in the future if the community begins to migrate from FITS to ASDF, for example, and will allow us to do format conversion on demand in the future (we currently support lossless conversion between FITS, HDF5, and JSON).
