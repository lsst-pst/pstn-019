...
The package that performs ISR on an exposure, called \texttt{ip_isr}, is a critical component of the pipelines used to process LSST images and requires calibration products produced and verified by the \texttt{cp_pipe} and \texttt{cp_verify} packages, as described in \secref{sec:calib_pipe}”
For further information about the production and  life cycle of a calibration product, and the associated procedures, see \citet{DMTN-222} and \citet{SITCOMTN-086}.
