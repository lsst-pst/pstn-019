...
First, astrometric and photometric solutions for each detector are fit independently to a reference catalog, which is sufficient for matching and filtering in subsequent, more sophisticated algorithms and validation.
