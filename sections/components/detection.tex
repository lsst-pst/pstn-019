...
The algorithm is described in more detail in \citet{DMTN-197}, which focuses on its application to differences between PSF-matched warps and a PSF-matched coadd, as described in \secref{sec:coaddition-and-objects}.
