...
These include second moment shapes (\texttt{base\_SdssShape}) and adaptive centroids (\texttt{base\_SdssCentroid}), circular aperture photometry (\texttt{base\_CircularApertureFlux}), PSF-weighted photometry (\text{base\_PsfFlux}), and many others.
