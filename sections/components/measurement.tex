...
We also distinguish between measurement on the original detection image vs. measurement on another image using that original detection.
...
While the measurement tasks and plugin interfaces are Python, most concrete measurement plugins are implemented in C++, since they need to loop over pixels.
