...
The coaddition process is divided into two main stages: resampling the input images onto a common projection (``warping'') defined by a \texttt{skymap} \secrefp{sec:core} and stacking those resampled images into a single coadd.
