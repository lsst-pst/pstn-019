...
\begin{figure}
    \centering
    \includegraphics[width=0.95\linewidth]{figures/analysis/source_injection/coadd_5063_gri_lsstRGB_3sigma}
    \includegraphics[width=0.95\linewidth]{figures/analysis/source_injection/coadd_5063_gri_lsstRGB_3sigma_inj}
    \includegraphics[width=0.95\linewidth]{figures/analysis/source_injection/coadd_5063_gri_lsstRGB_3sigma_diff}
    \caption{
