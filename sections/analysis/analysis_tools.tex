...
\texttt{analysis\_tools} is the successor to \texttt{faro} \citep{2022SPIE12189E..0MG}, \texttt{analysis\_drp} and \texttt{MetricTask} from the \texttt{verify} package.
...
\begin{figure}[ht]
\includegraphics[width=\linewidth]{atoolsPlot.pdf}
